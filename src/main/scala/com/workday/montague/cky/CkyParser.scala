...
/**
 * A generic CKY com.workday.montague.parser that fills a chart with cells of type C.
 *
...
/**
 * A CKY com.workday.montague.parser, where each cell is list of constituents that can be derived.
 *
